...
public class SoftAssertionHandlerPage extends FLUtilities {
    ...
    private void printSkippedElements(TestContext testContext) {
        ...
        scenario.log(resultSetSkippedElements.toString());
    }
    ...
    public void printTabularReport(List<List<String>> entries, TestContext testContext) {
        Scenario scenario = testContext.getScenario();
        StringBuilder resultSet = new StringBuilder();
        resultSet.append("<table border=\"1\" width=\"90%\"> <tr style='color: blue; font-weight: bold; background-color: #C5D88A;'> <th>S.No</th> <th>Form Name</th> <th>Wizard Name</th> <th>Common Tag</th> <th>Control Type</th> <th>Test Data</th> </tr>");

        for (List<String> entry : entries)
            resultSet.append("<tr style='color: green; font-weight: bold; background-color: #C5D88A;'> <td>").append(entry.get(0)).append("</td> <td>").append(entry.get(1)).append("</td> <td>").append(entry.get(2)).append("</td> <td>").append(entry.get(3)).append("</td> <td>").append(entry.get(4)).append("</td> <td>").append(entry.get(5)).append("</td> </tr>");
        resultSet.append("</table>");
        scenario.log(resultSet.toString());
    }
}