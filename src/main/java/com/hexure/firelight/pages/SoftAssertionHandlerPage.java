...
public class SoftAssertionHandlerPage extends FLUtilities {
     ...
     */
    public void assertTrue(WebDriver driver, String countValidation, String order, String jurisdictionApplication, String moduleName, String field, String distinctRule, String rule, Object actualValue, Object expectedValue, boolean condition, String xPath, TestContext testContext) {
        String result = "Passed";
        if (!condition) {
            captureScreenshot(driver, testContext, false);
            result = "Failed";
        }
        assertions.add(Arrays.asList(countValidation, order, jurisdictionApplication, moduleName, field, distinctRule, rule, actualValue.toString(), expectedValue.toString(), xPath, result));
    }
     ...
     */
    public void afterScenario(TestContext testContext, int fieldsEvaluated, String flow, String module) {
        assertAll(testContext, fieldsEvaluated, flow, module);
    }
     ...
     * @param fieldsEvaluated - Count of total evaluated fields
     */
    public void assertAll(TestContext testContext, int fieldsEvaluated, String flow, String module) {
     ...
     * @param fieldsEvaluated - Count of total evaluated fields
     */
    private void printResults(List<List<String>> assertions, TestContext testContext, int fieldsEvaluated, String flow, String module) {
        Scenario scenario = testContext.getScenario();
        StringBuilder resultSet = new StringBuilder();
        int countPassed = 0;
        int countFailed = 0;
        String displayPropertyOutbound = module.equalsIgnoreCase("E2E") || flow.equalsIgnoreCase("Outbound") ? "display : none;" : "";
        String displayPropertyIntegrations = !(flow.equalsIgnoreCase("Inbound") || flow.equalsIgnoreCase("Outbound")) ? "display : none;" : "";
        String displayPropertyE2E = module.equalsIgnoreCase("E2E") ? "display : none;" : "";
        String property = module.equalsIgnoreCase("E2E") || flow.equalsIgnoreCase("Outbound") ? "Field" : "Rules";
        String propertyFields = module.equalsIgnoreCase("E2E") ? "Field Validations" : "Rule";
        int skippedRulesCount = countSkippedRules(skippedRules, displayPropertyOutbound);
        int skippedElementsCount = countSkippedElements(skippedElements, displayPropertyOutbound);

        if (!assertions.isEmpty()) {
            resultSet.append("<table border=\"1\" width=\"100%\"> <tr> <th style=\"white-space: pre-wrap; width: 2%; vertical-align:top; padding-top: 5px; padding-bottom: 5px; padding-right:10px;\">S.No.</th>  <th style=\"" + displayPropertyE2E + " white-space: pre-wrap; width: 2%; vertical-align:top; padding-top: 5px; padding-bottom: 5px; padding-right:10px;\">Order</th> <th style=\"white-space: pre-wrap; width: 2%; vertical-align:top; padding-top: 5px; padding-bottom: 5px; padding-right:10px;\">Jurisdiction</th> <th style=\"white-space: pre-wrap; width: 2%; vertical-align:top; padding-top: 5px; padding-bottom: 5px; padding-right:10px;\">Module Name</th> <th>Field</th> <th>" + propertyFields + "</th> <th style=\"" + displayPropertyOutbound + "\">Validations</th> <th>Actual Value (UI)</th> <th>Expected Value (Excel Template)</th> <th style=\"" + displayPropertyIntegrations + "\">xPath</th> <th>Result</th> </tr>");
            for (List<String> assertion : assertions) {
                if (assertion.get(10).contains("Passed")) {
                    countPassed++;
                    resultSet.append("<tr style='color: green; font-weight: bold; background-color: #C5D88A;'> <td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(0)).append("</td> <td style='" + displayPropertyE2E + " vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(1)).append("</td> <td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(2)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(3)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(4)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(5).trim()).append("</td> <td style='" + displayPropertyOutbound + " white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(6).trim()).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(7)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(8)).append("</td> <td style='" + displayPropertyIntegrations + " vertical-align:top; min-width: 250px; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(9)).append("</td> <td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(10)).append("</td> </tr>");
                } else {
                    countFailed++;
                    resultSet.append("<tr style='color: red; font-weight: bold; background-color: #C5D88A;'> <td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(0)).append("</td> <td style='" + displayPropertyE2E + " vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(1)).append("</td> <td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(2)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(3)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(4)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(5).trim()).append("</td> <td style='" + displayPropertyOutbound + " white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(6).trim()).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(7)).append("</td> <td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(8)).append("</td> <td style='" + displayPropertyIntegrations + " vertical-align:top; min-width: 250px; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(9)).append("</td> <td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(10)).append("</td> </tr>");
                }
            }
            ...
            String executionSummary = "<div width='100%' style='font-size:3.1vw; border: none; color: green; font-weight: bold; background-color: #C5D88A;'>Execution Summary : </div>"
                    ...
                    + "<tr style='font-weight: bold; background-color: #28a745;'><td>Total Fields Evaluated</td><td>" + fieldsEvaluated + "</td></tr>"
        + "<tr style='font-weight: bold; background-color: #C5D88A;'><td>Fields Validated </td><td>" + (fieldsEvaluated - skippedElementsCount) + "</td></tr>"
                        ...
                        + "<tr style='" + displayPropertyOutbound + " font-weight: bold; background-color: #28a745;'><td>Total Rules Evaluated </td><td>" + (countFailed + countPassed + skippedRulesCount) + "</td></tr>"
                        + "<tr style='font-weight: bold; background-color: #C5D88A;'><td>" + property + " Validation Passed</td><td><font color=\"green\">" + countPassed + "</font></td></tr>"
                        + "<tr style='font-weight: bold; background-color: #C5D88A;'><td>" + property  + " Validation Failed</td><td><font color=\"red\">" + countFailed + "</font></td></tr>"
                        + "<tr style='" + displayPropertyOutbound + " font-weight: bold; background-color: #C5D88A;'><td>Rules Validation Skipped</td><td><font color=\"red\">" + skippedRulesCount + "</font></td></tr>"
                        + "</table>";
//            } else {
//                executionSummary += "<tr style='font-weight: bold; background-color: #C5D88A;'><td>Field Validation Passed</td><td><font color=\"green\">" + countPassed + "</font></td></tr>"
//                        + "<tr style='font-weight: bold; background-color: #C5D88A;'><td>Field Validation Failed</td><td><font color=\"red\">" + countFailed + "</font></td></tr>"
//                        + "</table>";
//            }
     ...
     */
    private int countSkippedElements(List<List<String>> assertions, String displayPropertyOutbound) {
        int count = 1;
        if (!assertions.isEmpty()) {
     ...
     */
    private int countSkippedRules(List<List<String>> assertions, String displayPropertyOutbound) {
        int serialNumber = 1;
        if (!assertions.isEmpty()) {
            resultSetSkippedRules.append("<table border=\"1\" width=\"100%\" style='" + displayPropertyOutbound + " color: black; background-color: #C5D88A;'> <tr> <th>S.No.</th> <th>Order</th> <th>Jurisdiction</th> <th>Module Name</th> <th>Field</th>  <th>Skipped Rule</th>  <th>Reason for skip</th></tr>");
            for (List<String> assertion : assertions) {
     ...
     * @param testContext - test context of a test case
     */
    private void printSkippedRules(TestContext testContext, String module, String flow) {
        Scenario scenario = testContext.getScenario();
