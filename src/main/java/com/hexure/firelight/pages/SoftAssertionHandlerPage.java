    ...
    private void printResults(List<List<String>> assertions, TestContext testContext, int fieldsEvaluated) {
        ...
        if (!assertions.isEmpty()) {
            ...
            for (List<String> assertion : assertions) {
                String rowColor = assertion.get(9).contains("Passed") ? "green" : "red";
                String backgroundColor = "#C5D88A";
                resultSet.append("<tr style='color: ").append(rowColor).append("; font-weight: bold; background-color: ").append(backgroundColor).append(";'>")
                        .append("<td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(0)).append("</td>")
                        .append("<td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(1)).append("</td>")
                        .append("<td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(2)).append("</td>")
                        .append("<td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(3)).append("</td>")
                        .append("<td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(4)).append("</td>")
                        .append("<td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(5).trim()).append("</td>")
                        .append("<td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(6).trim()).append("</td>")
                        .append("<td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(7)).append("</td>")
                        .append("<td style='white-space: pre-wrap; min-width: 250px; vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(8)).append("</td>")
                        .append("<td style='vertical-align:top; padding-top: 5px; padding-bottom: 5px;'>").append(assertion.get(9)).append("</td>")
                        .append("</tr>");
            }
